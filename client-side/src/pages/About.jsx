    ...
    <div className="mx-auto max-w-7xl px-4">
      <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
        ...
        <p className="max-w-4xl text-base text-gray-600 md:text-xl">
          Code, create, and innovate with us! Our online compiler is constantly
          evolving to meet your needs. Stay tuned for exciting new features and
          updates coming soon!
        </p>
      </div>
      ...
      <div className="my-8 flex flex-col gap-y-6 md:flex-row lg:justify-around">
        <div className="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
          ...
          <p className="w-full text-xl font-semibold  text-gray-900">Kanpur</p>
